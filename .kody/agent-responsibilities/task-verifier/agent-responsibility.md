...
Run the `task-verifier` agentAction. Its skills and scripts own the implementation details.

## Allowed Commands

- Run the `task-verifier` agentAction.

## Restrictions

- Stay within the agentResponsibility's purpose and the per-agentAction rules.
