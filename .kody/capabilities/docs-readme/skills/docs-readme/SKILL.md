...
Use this skill when the `docs-readme` agentAction runs from the matching agentResponsibility.
...
| `src/dashboard/lib/agent-actions/`                                                   | `docs/agent-actions.md`           |
...
in the engine README before enabling this agentResponsibility** (per the agent identity's hard rule);
