...
Use this skill only when the `documentation-maintenance` agentAction runs.
...
2. Discover user-facing surfaces from routes, navigation config, command palettes, menus, CLIs, public APIs, agentAction/agentResponsibility definitions, and tests.
