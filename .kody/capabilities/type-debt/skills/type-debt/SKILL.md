...
Use this skill when the `type-debt` agentAction runs from the matching agentResponsibility.
...
1. Job cannot grep locally. Trigger a Kody agentAction to count and report by opening (or reusing) the weekly tracking issue:
   ```
