...
The loop owns the recurring question and cadence. The matrix capability owns
deterministic inspection and its report. Task work movement belongs to the
separate `task-delivery` loop and workflow; the matrix itself stays read-only.
