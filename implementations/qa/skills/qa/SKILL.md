...
Use this skill when the `qa` implementation runs from the matching capability.
...
Browsing is delegated to the `qa-engineer` implementation (the job runs no browser
