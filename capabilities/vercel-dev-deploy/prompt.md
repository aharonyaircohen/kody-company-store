...
Deterministic implementation. The owned shell script deploys the configured dev branch to Vercel Preview and moves `a-guy-dev-aguy.vercel.app` to the new deployment.
