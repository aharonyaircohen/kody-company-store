...
Use the `agent-factory` implementation for model reasoning and state-repo PR creation.

The capability owns the public action name and the review boundary. The implementation owns reading the request issue, producing the structured bundle, and opening the configured state-repo PR.
