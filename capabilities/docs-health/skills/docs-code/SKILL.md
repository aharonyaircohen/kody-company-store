...
Use this skill when the `docs-code` implementation runs from the matching capability.
...
in the engine README before enabling this capability** (per the agent identity's hard rule);
